...
export function LiveWalkView({
  ...
  // Suscripción Realtime (solo mientras está en curso). La RLS filtra: ve el
  // recorrido el dueño del perro, el paseador y el admin.
  useEffect(() => {
    if (status !== "in_progress") return;
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        {enCurso ? (
          <span className="badge-brand">🟢 En curso</span>
        ) : cancelado ? (
